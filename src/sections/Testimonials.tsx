...
export const Testimonials = () => {
  return <section className=" py-20 md:py-24">
    <div className=" container">
      ...
      <p className=" text-center md:text-xl mt-5 tracking-tight text-white/70 text-lg mx-auto max-w-sm">our revolutionary AI SEI tools have transformed our clients strategies</p>
      ...
      {[...testimonials, ...testimonials].map(testimonials=>(
        ...
        bg-[linear-gradient(to_bottom_left,rgb(140,69,255,.3),black)] max-w-xs md:max-w-md flex-none">
          ...
          <div className=" text-sm text-white/50">{testimonials.title}</div>
          </div>
          </div>
        </div>
      ))}
